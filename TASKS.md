...
- [ ] 3.1 Implement the side-effect-free checkout rule evaluator and repository context read
...
- [ ] 3.2 Add the authenticated versioned capabilities API
...
- [ ] 3.3 Add the authenticated side-effect-free checkout-decision API
...
- [ ] 4.1 Refactor WinHTTP into externally configured Legacy and Connected endpoint transport
