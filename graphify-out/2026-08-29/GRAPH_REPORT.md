...
## Corpus Check
- 67 files · ~35,383 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 378 nodes · 577 edges · 41 communities (31 shown, 10 thin omitted)
...
Cohesion: 0.05
Nodes (32): North Star Architecture, Business-rule migration mode, Evaluation boundary, Implemented-state evidence, Summary, Architecture, Evidence confidence, Ownership implication (+24 more)
...
## Knowledge Gaps
- **130 isolated node(s):** `NativeRules`, `DesktopClient`, `NativeRulesTests`, `idempotency_records`, `audit_log` (+125 more)
...
- **Why does `Design Document: Service-Owned Client Business Rules` connect `Design Document: Service-Owned Client Business Rules` to `knowledge/index.md`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Requirements: Service-Owned Client Business Rules` connect `Requirements: Service-Owned Client Business Rules` to `knowledge/index.md`?**
